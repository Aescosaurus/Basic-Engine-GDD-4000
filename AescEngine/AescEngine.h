...
extern "C" AESCENGINE_API bool fibonacci_next();

// Get the current value in the sequence.
extern "C" AESCENGINE_API unsigned long long fibonacci_current();

// Get the position of the current value in the sequence.
extern "C" AESCENGINE_API unsigned fibonacci_index();